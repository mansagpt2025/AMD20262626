...
export function TechnicalSupportPage() {
  ...
  const telegramUsername = 'technicalsupport';
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
              <div className="relative h-64 bg-gradient-to-r from-blue-500 to-indigo-600">
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2">الدعم الفني</h1>
                    <p className="text-xl text-white/90">م. أحمد السيد</p>
                  </motion.div>
                </div>
              </div>
              ...
              <div className="p-8 md:p-12">
                <div className="text-center mb-8">
                  ...
                  <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">
                    ابعتلنا دلوقتي
                  </p>
                </div>
